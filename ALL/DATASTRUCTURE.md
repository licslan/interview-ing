...
![数据结构分类](https://github.com/licslan/interview-ing/raw/master/ALL-THING/DATASTRUCTURE/数据结构分类.png)<br> 
...
![堆](https://github.com/licslan/interview-ing/raw/master/ALL-THING/DATASTRUCTURE/栈.jpg)<br> 
栈的结构就像一个集装箱，越先放进去的东西越晚才能拿出来，所以，栈常应用于实现递归功能方面的场景，例如斐波那契数列。

### 3、队列
队列与栈一样，也是一种线性表，不同的是，队列可以在一端添加元素，在另一端取出元素，也就是：先进先出。从一端放入元素的操作称为入队，取出元素为出队，示例图如下：<br>
![队列](https://github.com/licslan/interview-ing/raw/master/ALL-THING/DATASTRUCTURE/队列.png)<br> 
...
![链表](https://github.com/licslan/interview-ing/raw/master/ALL-THING/DATASTRUCTURE/链表.png)<br> 
链表的优点： 
...
![树](https://github.com/licslan/interview-ing/raw/master/ALL-THING/DATASTRUCTURE/树.png)<br> 
 二叉树是树的特殊一种，具有如下特点：
...
![散列表](https://github.com/licslan/interview-ing/raw/master/ALL-THING/DATASTRUCTURE/哈希表.png)<br> 
...
![堆](https://github.com/licslan/interview-ing/raw/master/ALL-THING/DATASTRUCTURE/堆.png)<br>
...
![图](https://github.com/licslan/interview-ing/raw/master/ALL-THING/DATASTRUCTURE/无向图.png)<br>
![图](https://github.com/licslan/interview-ing/raw/master/ALL-THING/DATASTRUCTURE/有向图.png)<br>
